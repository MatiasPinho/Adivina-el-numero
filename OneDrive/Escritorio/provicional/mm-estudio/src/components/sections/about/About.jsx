...
export const About = () => {
  return (
    <section className='about__container' id='about-id'>
      <div className='about'>
        <div className='row__about__left'>
          <article className='article__about__left'>
            <span className='opacity__title'>sobre nosotros</span>
        ...
        <div className='row__about__right'>
          <img className='image__about' src='/images/about_image.png' alt='' />
